...
void main() {
  testWidgets('Basic Wrap test', (WidgetTester tester) async {
    await tester.pumpWidget(
      new Wrap(
        primaryAlignment: WrapAlignment.start,
        children: <Widget>[
    ...
    await tester.pumpWidget(
      new Wrap(
        primaryAlignment: WrapAlignment.center,
        children: <Widget>[
          new SizedBox(width: 300.0, height: 100.0),
          new SizedBox(width: 300.0, height: 100.0),
          new SizedBox(width: 300.0, height: 100.0),
    ...
    await tester.pumpWidget(
      new Wrap(
        primaryAlignment: WrapAlignment.end,
        children: <Widget>[
          new SizedBox(width: 300.0, height: 100.0),
          new SizedBox(width: 300.0, height: 100.0),
          new SizedBox(width: 300.0, height: 100.0),
    ...
    await tester.pumpWidget(
      new Wrap(
        primaryAlignment: WrapAlignment.start,
        secondaryAlignment: WrapCrossAlignment.start,
        children: <Widget>[
    ...
    await tester.pumpWidget(
      new Wrap(
        primaryAlignment: WrapAlignment.start,
        secondaryAlignment: WrapCrossAlignment.center,
        children: <Widget>[
          new SizedBox(width: 300.0, height: 50.0),
          new SizedBox(width: 300.0, height: 100.0),
          new SizedBox(width: 300.0, height: 100.0),
    ...
    await tester.pumpWidget(
      new Wrap(
        primaryAlignment: WrapAlignment.start,
        secondaryAlignment: WrapCrossAlignment.end,
        children: <Widget>[
          new SizedBox(width: 300.0, height: 50.0),
          new SizedBox(width: 300.0, height: 100.0),
          new SizedBox(width: 300.0, height: 100.0),
