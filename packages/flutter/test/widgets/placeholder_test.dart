...
void main() {
  testWidgets('Placeholder', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(new Center(child: new Placeholder()));
    expect(tester.renderObject<RenderBox>(find.byType(Placeholder)).size, const Size(800.0, 600.0));
    await tester.pumpWidget(new Stack(children: <Widget>[new Positioned(top: 0.0, bottom: 0.0, child: new Placeholder())]));
    expect(tester.renderObject<RenderBox>(find.byType(Placeholder)).size, const Size(400.0, 600.0));
    await tester.pumpWidget(new Stack(children: <Widget>[new Positioned(left: 0.0, right: 0.0, child: new Placeholder())]));
    expect(tester.renderObject<RenderBox>(find.byType(Placeholder)).size, const Size(800.0, 400.0));
    await tester.pumpWidget(new Stack(children: <Widget>[new Positioned(top: 0.0, child: new Placeholder(fallbackWidth: 200.0, fallbackHeight: 300.0))]));
  ...
  testWidgets('Placeholder color', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(new Placeholder(color: const Color(0xFF00FF00)));
