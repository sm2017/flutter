...
class BorderSide {
  ...
  /// sides.
  ///
  /// If both sides are null, then this will return null.
  factory BorderSide.merge(BorderSide a, BorderSide b) {
    assert(canMerge(a, b));
    if (a == null)
...
class Border extends ShapeBorder {
  ...
  factory Border.merge(Border a, Border b) {
    ...
    return new Border(
      top: new BorderSide.merge(a.top, b.top),
      right: new BorderSide.merge(a.right, b.right),
      bottom: new BorderSide.merge(a.bottom, b.bottom),
      left: new BorderSide.merge(a.left, b.left),
    );
  }
