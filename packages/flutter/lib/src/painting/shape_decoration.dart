...
class ShapeDecoration extends Decoration {
  ...
  ///
  /// The [color] and [gradient] properties are mutually exclusive, one of them
  /// must be null.
  ///
  ...
  /// because [ShapeDecoration] has to be more general since it can support any
  /// shape. However, having a [ShapeDecoration] is sometimes necessary, for
  /// example when calling [ShapeDecoration.lerp].
    ...
    switch (source.shape) {
      case BoxShape.circle:
        if (source.border != null) {
          ...
          shape = new CircleBorder(BorderSide.none);
        }
        break;
  ...
  bool hitTest(Size size, Offset position) {
    ...
    path
      ...
      ..addPath(shape.getInnerPath(rect), Offset.zero);
